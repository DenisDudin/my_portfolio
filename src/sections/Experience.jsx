    ...
    <div className="experience_content">
      <div className="experience_left side">
        ...
        <div className="experience_box">
          ...
          <p>Магистратура.<br />Факультет информатики и систем управления.<br />Информационная безопасность.</p>
        </div>{/* experience_box */}

         <div className="experience_box">
          <h4>2015 - 2019</h4>
          <h3>БГТУ им. В.Г. Шухова</h3>
          <p>Бакалавриат.<br /> Факультет программного обеспечения вычислительной техники и автоматизированных систем.<br />Информатика и вычислительная техника.</p>
        </div>{/* experience_box */}
      ...
      <div className="experience_right side">
        ...
        <div className="experience_box">
          ...
          <ul>
            ...
            <li>Заключение сделок и поддержание партнерства с другими компаниями;</li>
            <li>Работа с рекламными площадками, их настройка и и раскрутка товара.</li>
          </ul>
          <p>Достижения:</p>
          <ul>
        ...
        <div className="experience_box">
          ...
          <p>Обязанности:</p>
          <ul>
            <li>Проверка компаний на соответствие международным стандартам в области ИБ;</li>
            <li>Обнаружение ошибок и нарушений в проведенных транзакциях компаний;</li>
